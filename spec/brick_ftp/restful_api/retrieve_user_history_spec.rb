  ...
  describe '#call' do
    context 'correct request' do
      it 'return Array of History object' do
        ...
        url = 'https://subdomain.files.com/api/rest/v1/history/users/54321.json?page=1&per_page=1&start_at=2018-08-17T00:00:00Z'
        ...
        res = command.call(user_id: 54_321, page: 1, per_page: 1, start_at: Time.parse('2018-08-17T00:00:00Z'))
