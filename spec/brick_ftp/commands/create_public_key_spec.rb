...
RSpec.describe BrickFTP::Commands::CreatePublicKey, type: :lib do
  describe '#call' do
    context 'given correct parameters' do
      it 'return created User Public key object' do
        ...
        params = BrickFTP::Commands::CreatePublicKey::Params.new(title: 'mykey')
        command = BrickFTP::Commands::CreatePublicKey.new(rest)
        public_key = command.call(1234, params)

        expect(public_key).to eq created_public_key
      end
    end
  end
end
