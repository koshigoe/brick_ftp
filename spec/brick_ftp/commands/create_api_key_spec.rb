...
RSpec.describe BrickFTP::Commands::CreateAPIKey, type: :lib do
  describe '#call' do
    context 'given correct parameters' do
      it 'return created User API key object' do
        ...
        stub_request(:post, 'https://subdomain.brickftp.com/api/rest/v1/users/1234/api_keys.json')
          .with(
        ...
        params = BrickFTP::Commands::CreateAPIKey::Params.new(name: 'mykey')
        command = BrickFTP::Commands::CreateAPIKey.new(rest)
