...
RSpec.describe BrickFTP::Commands::CreateUser, type: :lib do
  describe '#call' do
    context 'given correct parameters' do
      it 'return created User object' do
        ...
        params = BrickFTP::Commands::CreateUser::Params.new(username: 'user')
        command = BrickFTP::Commands::CreateUser.new(rest)
