  ...
  module Commands
    class CreateUser
      ...
      Params = Struct.new(
        ...
        :grant_permission,        # enum                     | Value must be set to full, read, write, preview, read+write, or preview+write.
                                  #                          | The user will be granted that permission on their FTP root folder as defined by the user_root.
                                  #                          | This property is write-only. It cannot be retrieved via the User resource of the REST API, though may be obtained with the Permissions resource of the REST API.
        :ssl_required,            # enum                     | Whether or not SSL encryption is required on all connections for this user. Can be one of the following: use_system_setting, always_require, or never_require.
                                  #                          | Default is use_system_setting.
      ...
      #
      # @param [BrickFTP::Commands::CreateUser::Params] params parameters for create a user
